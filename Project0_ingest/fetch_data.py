...
stock = input("Enter Stock Ticker (e.g. AAPL): ") or config.symbol
start_date = input("Enter Start Date (YYYY-MM-DD): ") or config.start_date
end_date = input("Enter End Date (YYYY-MM-DD): ") or config.end_date
...
print(df.to_string())  # Return Stock Historical DataFrame